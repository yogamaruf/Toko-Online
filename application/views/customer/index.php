	...
	<div class="topNav">
		<div class="container">
			<div class="alignR">
				...
				<a href="<?php echo base_url('index.php/toko/'); ?>"><span class="icon-user"></span> My Account</a> 
				...
				<a href="<?php echo base_url('index.php/toko/keranjang'); ?>"><span class="icon-shopping-cart"></span> 0 Item(s) - <span class="badge badge-warning"> Rp. 0 </span></a>
			</div>
		</div>
	</div>
</div>
