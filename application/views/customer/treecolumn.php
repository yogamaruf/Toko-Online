		...
		<?php foreach ($data->result_array() as $key => $value) { ?>
			...
			<li class="span4">
			  	...
			  	<div class="thumbnail">
					...
					<a href="<?php echo base_url('index.php/toko/detailproduk/').$value['idproduk']; ?>"><img style="height: 290px;" src="<?php echo base_url(); ?>assets/gambar/produk/<?php echo $value['foto']; ?>" alt=""></a>
