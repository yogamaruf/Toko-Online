	...
	<div class="row-fluid">
            ...
            <div class="tab-pane fade active in" id="home">
			  <h4>Product Information</h4>
				...
				<tbody>
				<tr class="techSpecRow"><td class="techSpecTD1">Color:</td><td class="techSpecTD2"><?php echo $d['warna']; ?></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Sport:</td><td class="techSpecTD2"><?php echo $d['idkategori']; ?></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Brand:</td><td class="techSpecTD2"><?php echo $d['namamerk']; ?></td></tr>
				</tbody>
				</table>
